...
@section('content')
    <form class="form-horizontal" id="form_landing_page" method="POST" action="{{ route('cms.landing-page.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="sort_order" name="sort_order" parsley-trigger="change" placeholder="Masukan section key..." value="{{ old('sort_order') }}" required>
                                @error('sort_order')
                            ...
                            <div class="form-group">
                                ...
                                <select name="section_id" id="section_id" class="form-control" required>
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{$section['id']}}"  {{ old('section_id') == $section['id'] ? 'selected' : '' }}>{{$section['nama']}}</option>
                                    @endforeach
                                </select>
                                @error('section_id')
                                    <small class="text-danger">{{$message}}</small>
