...
class KategoriDokumenController extends Controller
{
    ...
    {
        return view('backend.master-data.kategori-dokumen.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            $kategoriDokumen = new MdKategoriDokumen;
            $kategoriDokumen->user_id = Auth::user()->id;
            $kategoriDokumen->nama = $request->nama;
    ...
    public function show(string $id)
    {
        ...
        $getData = MdKategoriDokumen::find($id);
        $dataSend = [
            'nama' => $getData->nama
        ];
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $kategoriDokumen = MdKategoriDokumen::find($id);
            $kategoriDokumen->nama = $request->nama;
            $kategoriDokumen->save();
    ...
    public function destroy(string $id)
    {
        try {
            $id = Crypt::decryptString($id);
            $kategoriDokumen = MdKategoriDokumen::find($id);
            $kategoriDokumen->status_aktif = '0';
            $kategoriDokumen->save();
